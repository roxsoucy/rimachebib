<?php /* Template Name: accueil */ get_header(); ?>
	...
	<main role="main">
		<!-- section -->
		<section id="apropos" class="section1 anchor" style="background-image: url(<?php echo get_template_directory_uri(); ?>/img/placeholder.jpg);">
			<div class="container">
				<div class="row">
		...
		<section id="services" class="section2 anchor">
			<div class="container">
				<div class="row">
		...
		<!-- /section2 -->	
		<section id="lookbook" class="anchor">
