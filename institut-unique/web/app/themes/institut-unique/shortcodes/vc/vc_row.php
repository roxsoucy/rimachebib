...
if (function_exists('vc_map_get_attributes')) {						// New VC
	 ...
	 * @var $scheme		- added by Jacqueline
	 * @var $inverse	- added by Jacqueline
	 * @var $atts
	 * @var $el_class
	 * @var $full_width
	 * @var $full_height
	...
	// Added by Jacqueline:
	// Color scheme
	if ($scheme && !jacqueline_param_is_off($scheme) && !jacqueline_param_is_inherit($scheme)) $css_classes[] = 'scheme_'.esc_attr($scheme);
	// Inverse colors
	if ($inverse && !jacqueline_param_is_off($inverse)) $css_classes[] = 'inverse_colors';
	...
	// Add Jacqueline color scheme in the row
	if ($scheme && !jacqueline_param_is_off($scheme) && !jacqueline_param_is_inherit($scheme)) $css_class .= ' scheme_'.esc_attr($scheme);
