...
<a href="#" class="top_panel_cart_button" data-items="<?php echo esc_attr($cart_items); ?>" data-summa="<?php echo esc_attr($cart_summa); ?>">
	...
	<span class="contact_label contact_cart_label"><?php esc_html_e('Your cart:', 'jacqueline'); ?></span>
	<span class="contact_cart_totals">
		<span class="cart_items"><?php
			echo esc_html($cart_items) . ' ' . ($cart_items == 1 ? esc_html__('Item', 'jacqueline') : esc_html__('Items', 'jacqueline'));
		?></span>
		- 
