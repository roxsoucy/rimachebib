...
// Theme init
if (!function_exists('jacqueline_html_theme_setup')) {
	add_action( 'jacqueline_action_before_init_theme', 'jacqueline_html_theme_setup' );
	function jacqueline_html_theme_setup() {

		// Set e-mail content type to html for the wp_mail()
		add_filter( 'wp_mail_content_type', 'jacqueline_set_html_content_type' );
...
if (!function_exists('jacqueline_set_html_content_type')) {
	function jacqueline_set_html_content_type() {
		return 'text/html';
	}
}
