...
// Shortcode template
if ( ! class_exists( 'JACQUELINE_VC_ShortCode' ) ) {
	abstract class JACQUELINE_VC_ShortCode extends WPBakeryShortCode {
...
if ( ! class_exists( 'JACQUELINE_VC_ShortCodeSingle' ) ) {
	abstract class JACQUELINE_VC_ShortCodeSingle extends JACQUELINE_VC_ShortCode {
	}
}

// Single shortcode without params (woocommerce_cart, checkout, etc.)
if ( ! class_exists( 'JACQUELINE_VC_ShortCodeAlone' ) ) {
	abstract class JACQUELINE_VC_ShortCodeAlone extends JACQUELINE_VC_ShortCode {
		protected $controls_list = array('clone', 'delete');
	}
}

// Container shortcode (block, section, parallax)
if ( ! class_exists( 'JACQUELINE_VC_ShortCodeContainer' ) ) {
	abstract class JACQUELINE_VC_ShortCodeContainer extends JACQUELINE_VC_ShortCode {
...
if ( ! class_exists( 'JACQUELINE_VC_ShortCodeCollection' ) ) {
	abstract class JACQUELINE_VC_ShortCodeCollection extends JACQUELINE_VC_ShortCodeContainer {
		protected $controls_css_settings = 'out-tc vc_controls-content-widget';
		protected $controls_list = array('add', 'edit', 'clone', 'delete');
	}
}
...
if ( ! class_exists( 'JACQUELINE_VC_ShortCodeItem' ) ) {
	abstract class JACQUELINE_VC_ShortCodeItem extends JACQUELINE_VC_ShortCode {
...
if ( ! class_exists( 'JACQUELINE_VC_ShortCodeColumns' ) ) {
	abstract class JACQUELINE_VC_ShortCodeColumns extends JACQUELINE_VC_ShortCodeContainer {
		protected $controls_css_settings = 'out-tc vc_controls-content-widget';
		protected $controls_list = array('add', 'edit', 'clone', 'delete');
	}
}
...
if ( !class_exists('JACQUELINE_VC_ShortCodeAccordion') ) {
	abstract class JACQUELINE_VC_ShortCodeAccordion extends WPBakeryShortCode_VC_Accordion {}
	abstract class JACQUELINE_VC_ShortCodeAccordionItem extends WPBakeryShortCode_VC_Accordion_tab {}
}
if ( !class_exists('JACQUELINE_VC_ShortCodeToggles') ) {
	abstract class JACQUELINE_VC_ShortCodeToggles extends JACQUELINE_VC_ShortCodeAccordion {}
	abstract class JACQUELINE_VC_ShortCodeTogglesItem extends JACQUELINE_VC_ShortCodeAccordionItem {}
}
...
if ( ! class_exists( 'JACQUELINE_VC_ShortCodeTabs' ) ) {
	abstract class JACQUELINE_VC_ShortCodeTabs extends WPBakeryShortCode_VC_Tabs {
		public function setCustomTabId( $content ) {
			return preg_replace( '/tab\_id\=\"([^\"]+)\"/', 'tab_id="sc_tab_$1_' . time() . '"', $content );
		}
	}
	abstract class JACQUELINE_VC_ShortCodeTab extends WPBakeryShortCode_VC_Tab {
	}
}
